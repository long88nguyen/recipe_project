    ...
    class="add-timesheet-modal"
        ...
        <div class="form_input-category">
            <form @submit.prevent="addCategory" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control" v-model="banner.content" @blur="validate()">
    ...
    methods: {
        ...
        async addCategory()     
        {
            ...
            if(this.validate())
            {
                ...
                await this.$store.dispatch("banners/creataBanner",formData)
                .then(() =>{
                    this.$toast.success('Thêm mới thành công !');
                    this.$emit("ok");
                    this.$router.push({ path: "/banner" });
                    this.banner.content = null;
